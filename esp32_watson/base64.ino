...
int Base64encode(char *output, char *input, int inputLength) {
  int i = 0, j = 0;
  int encodedLength = 0;
  unsigned char A3[3];
  unsigned char A4[4];
...
int Base64decode(char * output, char * input, int inputLength) {
  int i = 0, j = 0;
  int decodedLength = 0;
  unsigned char A3[3];
  unsigned char A4[4];
...
int Base64decodedLength(char * input, int inputLength) {
  int i = 0;
  int numEq = 0;
